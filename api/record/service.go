...
func NewService(i int, s ldb.Service, m *TiplocMap, rm *ReasonMap) Service {
  ...
  r := Service{
    ...
    TrainId:     s.TrainId,
    Toc:         s.Toc,
    Cancel:      rm.Resolve(true, s.CancelReason),
    Late:        rm.Resolve(false, s.LateReason),
...
// 15 1 reason  Cancel reason, 0=none
// 17 1 reason  Late reason, 0=none
//
